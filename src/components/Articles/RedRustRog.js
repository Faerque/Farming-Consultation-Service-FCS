...
import RedRustRogImg from './Assets/RedRust.jpg';
// blog with image on the left side and text on the right side - start
const RedRustRog = () => {
    return (
        <div>
