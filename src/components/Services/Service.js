...
const Service = ({ service }) => {
    ...
    return (
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
                class="mb-8 rounded-md bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10"
            >
                <div
                    class="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-xl"
                >
                    <svg
                        width="32"
                        height="32"
