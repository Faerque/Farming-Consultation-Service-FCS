        ...
        <section>
            <div class="flex">
                ...
                <div class="flex-1 w-64 ">
                    <div className='flex'>
                        <div className='ml-24 mr-24 mt-20 '><div class="overflow-hidden bg-white shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:px-6">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Service Request By User</h3>
